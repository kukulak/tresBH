...
// IMPORT MODULES
import ProyectosTitulo from '../../proyectos/ProyectosTitulo.component';
import ProyectosPicture from '../../proyectos/ProyectosPicture.component';
import ProyectosDescripcion from '../../proyectos/ProyectosDescripcion.component';
...
function Proyectos(props) {
    ...
    return(
        ...
        <div className={ `detailProject projects cp${doUltraClass(props.index)}` }>
